...
const CatalogSection = () => {
  ...
  // Obtener todos los perfumes de nuestros archivos de datos
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-8 mb-12">
          {filteredProducts.map((product) => (
            <Card
              key={product.name + product.id + product.category}
            ...
            >
              <CardContent className="flex flex-col items-center">
                <div className="aspect-square w-[120px] h-[120px] mb-4 overflow-hidden rounded-lg bg-white flex items-center justify-center">
                  <Image
                    src={product.image}
                    alt={product.name}
